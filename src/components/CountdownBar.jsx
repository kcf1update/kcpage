...
>
      ...
      <div className="grid w-full grid-cols-[1.2fr_1fr_0.8fr] items-center gap-2 sm:gap-4">

        {/* RACE NAME */}
        <div className="flex min-w-0 items-center gap-2">
          <span className="text-[10px] font-extrabold text-black sm:text-base lg:text-lg">
          ...
          <img
            src="/flags/az.png"
            alt="Azerbaijan flag"
            className="h-3 w-auto shrink-0 sm:h-4 lg:h-5"
          />
        </div>
        ...
        <div className="min-w-0 text-center">
          {weekendStarted ? (
            <span className="text-[9px] font-bold uppercase tracking-wide text-black sm:text-xs lg:text-sm">
              RACE WEEKEND UNDERWAY • FOLLOW THE WEEKEND IN RACE CENTRE
            </span>
          ) : (
            <span className="whitespace-nowrap text-[9px] font-bold text-black sm:text-xs lg:text-sm">
