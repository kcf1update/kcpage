...
export default function CountdownBar() {
  const getTimeRemaining = () => {
    const targetTime = new Date("2026-09-04T04:30:00Z").getTime();
    const now = Date.now();
  ...
  return (
    ...
    >
      <img src="/flags/it.png" alt="Italian flag" className="h-4 w-auto" />
      <span>PIRELLI GRAN PREMIO D'ITALIA</span>
