...
export default function CountdownBar() {
  const getTimeRemaining = () => {
    const targetTime = new Date("2026-06-12T11:30:00Z").getTime();
    const now = Date.now();
  ...
  return (
    ...
    >
      <img src="/flags/es.png" alt="Spanish flag" className="h-4 w-auto" />
      <span>FORMUAL 1 MSC CRUISES GRAN PREMIO DE BARCELONA-CATALUNYA GRAND PRIX</span>
